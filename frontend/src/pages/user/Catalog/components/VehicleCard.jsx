...
export default function VehicleCard({ car }) {
  ...
  // 3. Images
  let imgUrl = asset?.media?.thumbnail ? getImageUrl(asset.media.thumbnail) : "https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&q=80";
  ...
  const currentPrice = auction?.current_price ? auction.current_price.toLocaleString() : "N/A";

  return (
    <Link 
      to={`/auction/${auction?.id || asset?.id}`} 
      state={{ car: { auction, asset } }} 
